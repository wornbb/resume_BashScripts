...
#$simulation/utils/MulPtrace.py -i $pt2c -o $ptNew -n 16 
#timeout 30h $software/voltspot20/voltspot  -c $software/voltspot20/pdn4c.config -f $des/vp/chips/22nm/Penryn22_ruby_ya_16c_v13.flp -p $ptNew -v $vtrace -gridvol_file $gridIR > buffer
#mv $dump/${gridIR}powerG $powerG
python $analysis/pyscripts/getCurrent.py -p $powerG -v $gridIR -o $current
#rm -rf $powerG
ln $current /data/ToMarco/Yaswanth16c/Yaswan16c.current
ln $gridIR /data/ToMarco/Yaswanth16c/Yaswan16c.gridIR
python /data/ToMarco/getV11.py -v $gridIR -o /data/ToMarco/Yaswanth16c/v11
chmod 777 /data/ToMarco/Yaswanth${core}/*
