...
#$simulation/utils/MulPtrace.py -i $pt2c -o $ptNew -n $num 
timeout 2h $software/voltspot20/voltspot  -c $software/voltspot20/pdn4c.config -f $des/vp/chips/22nm/Penryn22_ruby_ya_${core}_v13.flp -p $ptNew -v $vtrace -gridvol_file $gridIR > buffer
